view: v_google_consumption {
  ...
  dimension_group: usage_end_time_utc {
    type: time
    timeframes: [
      raw,
      time,
  ...
  dimension_group: usage_start_time_utc {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.usage_start_time_utc ;;
  }
...
view: v_google_consumption__labels {
  dimension: key {
    type: string
    sql: key ;;
  }

  dimension: v_google_consumption__labels {
    type: string
    hidden: yes
    sql: v_google_consumption__labels ;;
  }
...
view: v_google_consumption__credits {
  drill_fields: [id]
  ...
  dimension: v_google_consumption__credits {
    type: string
    hidden: yes
    sql: v_google_consumption__credits ;;
  }
}

view: v_google_consumption__system_labels {
  dimension: key {
    type: string
    sql: key ;;
  }

  dimension: v_google_consumption__system_labels {
    type: string
    hidden: yes
    sql: v_google_consumption__system_labels ;;
  }
...
view: v_google_consumption__project__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: v_google_consumption__project__ancestors {
